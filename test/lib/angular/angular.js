 ...
 * angularTemplate.run(function($templateCache) {
 ...
 *    angular.module('angularTemplate', []).config(function($sceDelegateProvider) {
...
<file name="index.html">
  <div ng-controller="angularTemplateController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("angularTemplateController", function angularTemplateController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('angularTemplateWithSceDisabledangularTemplate', []).config(function($sceProvider) {
