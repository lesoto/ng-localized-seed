 ...
 *
 * <pre>
 *   angularTemplateDev = angular.module('angularTemplateDev', ['angularTemplate', 'ngMockE2E']);
 *   angularTemplateDev.run(function($httpBackend) {
...
window.jasmine && (function (window) {
     ...
     * <pre>
     *
     *   angular.module('angularTemplatelicationModule', [])
     *       .value('mode', 'app')
   ...
   *     beforeEach(module('angularTemplatelicationModule'));
   *
   *
